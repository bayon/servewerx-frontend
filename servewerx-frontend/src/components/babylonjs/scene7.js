...
var createScene7 = function(engine, canvas) {
        ...
        function() {
            var exponentialPath = function(p) {
                ...
                for (var i = -50; i <= 50; i++) {
                    path.push(
                        new BABYLON.Vector3(
                            p - 50,
                            Math.sin(p / 3) * 10 * Math.exp((i - p) / 100) +
                                i / 3,
                            i
                        )
                    );
            ...
            scene.registerBeforeRender(function() {
                ...
                for (var ii = 0; ii < 4; ii++) {
                    ...
                    box.position.y = 150;
                    box.position.x =
                        Math.random() * 100 * (ii % 2 == 1 ? -1 : 1);
                    box.position.z =
                        Math.random() * 100 * (ii % 3 == 1 ? -1 : 1);
